            ...
            <div className="row">
              ...
              <div className="col-md-12 mb-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li><i className="bi bi-envelope-fill me-2"></i><a href="mailto:info@example.com" style={{ color: '#003c8f' }}>climberra00@gmail.com</a></li> {/* เปลี่ยนสีข้อความ */}
                  <li><i className="bi bi-telephone-fill me-2"></i><a href="tel:+1234567890" style={{ color: '#003c8f' }}>+66957350904</a></li> {/* เปลี่ยนสีข้อความ */}
                </ul>
              </div>
            </div>
          </div>
